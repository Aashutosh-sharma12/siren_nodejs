...
exports.offline_online_all_rooms = exports.added_user_to_room = exports.delete_user_all_data = exports.left_all_rooms = exports.update_msg_status = exports.all_participant_seen_msg = exports.generate_timestamp_In_seconds = void 0;
...
const offline_online_all_rooms = async (data) => {
    try {
        ...
        let arr = [];
        if (status == "offline") {
            await dynamic_room_1.default.updateMany({ roomId: { $in: roomIds }, joinedBy: userId, isActive: true }, { isActive: false, last_online_timeStamp: generate_timestamp_In_seconds() });
        }
        if (usersWithSockets.length) {
            for (let u of usersWithSockets) {
                const emit_details = {
...
exports.offline_online_all_rooms = offline_online_all_rooms;
