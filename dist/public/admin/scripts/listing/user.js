        ...
        success: function (data, status) {
            ...
            if (data.code == 200 && data.totalCount > 0) {
                ...
                for (let item of itemList) {
                    ...
                    let en_rolled = '<button type = "button" class="btn btn-sm btn-info" style = "margin: 5px;"  data - toggle="modal" data - target="#myModal21" onclick = en_rolled(' + '\'' + userId + '\'' + ')>' + 'En-Rolled' + '</button>'
                    if (item.subscribed == true) {
                        en_rolled = '<button type = "button" class="btn btn-sm btn-info" style = "margin: 5px;" disabled  data - toggle="modal" data - target="#myModal21" onclick = en_rolled(' + '\'' + userId + '\'' + ')>' + 'En-Rolled' + '</button>'
                    }
