...
userRouter.get(p.user_sub_list, authValidator_1.verifyAuthToken, (0, authValidator_1.checkRole)(["admin"]), user_1.default.user_sub_list);
userRouter.post(p.purchase_subscription, authValidator_1.verifyAuthToken, (0, authValidator_1.checkRole)(["admin"]), (0, schemaValidator_1.schemaValidator)(adminValidator_1.add_subscription), user_1.default.purchase_subscription);
