...
(async () => {
    try {
        ...
        // await copy('./src/pre-start/env/production.env.enc', './dist/pre-start/env/production.env.enc');
        // await copy('./src/pre-start/env/development.env.enc', './dist/pre-start/env/development.env.enc');
